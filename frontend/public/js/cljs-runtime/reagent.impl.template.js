...
var temp__5808__auto___21989 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21989 == null)){
} else {
var key_21991 = temp__5808__auto___21989;
(jsprops.key = key_21991);
}
...
var temp__5808__auto___21993 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5808__auto___22000 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22000 == null)){
} else {
var key_22002 = temp__5808__auto___22000;
(jsprops.key = key_22002);
}
...
var temp__5808__auto___22005 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22005 == null)){
} else {
var key_22006 = temp__5808__auto___22005;
(jsprops.key = key_22006);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21957_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21957_SHARP_);
}),s));
});
...
break;
default:
var G__22016 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22017 = compiler;
v = G__22016;
compiler = G__22017;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template21969 = (function (opts,id,fn_to_element,parse_fn,meta21970){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21969.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21971,meta21970__$1){
var self__ = this;
var _21971__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21969(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21970__$1));
}));

(reagent.impl.template.t_reagent$impl$template21969.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21971){
var self__ = this;
var _21971__$1 = this;
return self__.meta21970;
}));

(reagent.impl.template.t_reagent$impl$template21969.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21969.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21969.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21969.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21969.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21969.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21970","meta21970",-1946492516,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21969.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21969.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21969");

(reagent.impl.template.t_reagent$impl$template21969.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template21969");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21969.
 */
reagent.impl.template.__GT_t_reagent$impl$template21969 = (function reagent$impl$template$__GT_t_reagent$impl$template21969(opts,id,fn_to_element,parse_fn,meta21970){
return (new reagent.impl.template.t_reagent$impl$template21969(opts,id,fn_to_element,parse_fn,meta21970));
});
...
return (new reagent.impl.template.t_reagent$impl$template21969(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
