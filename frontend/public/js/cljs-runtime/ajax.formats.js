...
var G__23424 = request;
var G__23425 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__23424,G__23425) : ajax.formats.get_format.call(null,G__23424,G__23425));
} else {
...
return cljs.core.some((function (p1__23434_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__23434_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__23436){
var map__23437 = p__23436;
var map__23437__$1 = cljs.core.__destructure_map(map__23437);
var request = map__23437__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23437__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__23442 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__23442.cljs$core$IFn$_invoke$arity$1 ? fexpr__23442.cljs$core$IFn$_invoke$arity$1(response) : fexpr__23442.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__23444){
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__23443_SHARP_){
return ajax.formats.get_accept_entries(request,p1__23443_SHARP_);
