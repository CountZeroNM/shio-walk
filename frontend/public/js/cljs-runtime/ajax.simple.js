...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__23458){
var map__23459 = p__23458;
var map__23459__$1 = cljs.core.__destructure_map(map__23459);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23459__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__23460_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__5002__auto__ = p1__23460_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__23461){
var map__23462 = p__23461;
var map__23462__$1 = cljs.core.__destructure_map(map__23462);
var request = map__23462__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23462__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
