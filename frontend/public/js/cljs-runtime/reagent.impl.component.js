...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21477 = c;
var G__21477__$1 = (((G__21477 == null))?null:G__21477.prototype);
if((G__21477__$1 == null)){
return null;
} else {
return G__21477__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21479 = c;
var G__21479__$1 = (((G__21479 == null))?null:G__21479.prototype);
if((G__21479__$1 == null)){
return null;
} else {
return G__21479__$1.render;
}
})() == null)))));
});
...
while (G__21753__i < G__21753__a.length) {G__21753__a[G__21753__i] = arguments[G__21753__i + 0]; ++G__21753__i;}
  args = new cljs.core.IndexedSeq(G__21753__a,0,null);
} 
return G__21751__delegate.call(this,args);};
G__21751.cljs$lang$maxFixedArity = 0;
G__21751.cljs$lang$applyTo = (function (arglist__21755){
var args = cljs.core.seq(arglist__21755);
...
var or__5002__auto__ = (function (){var G__21500 = c;
var G__21500__$1 = (((G__21500 == null))?null:G__21500.constructor);
if((G__21500__$1 == null)){
return null;
} else {
return G__21500__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__21505 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21506 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21506);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21505);
}});
...
var c = this;
var G__21524_21833 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21524_21833 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21524_21833);
}
...
var renders_21852 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21853 = cljs.core.first(cljs.core.vals(renders_21852));
...
if((cljs.core.count(renders_21852) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21852))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21853)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21853], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21598 = o;
reagent.impl.component.goog$module$goog$object.set(G__21598,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21639 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21640 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21640);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21639);
}});
...
var vec__21650 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21650,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21650,(1),null);
...
var G__21685 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21685 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21685);
}
});
}),[]);
